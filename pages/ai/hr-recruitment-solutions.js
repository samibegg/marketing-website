// pages/ai/hr-recruitment-solutions.js // Renamed for clarity, adjust as needed
...
// import { Users2, UserCheck, Users, Settings, SearchCode } from 'lucide-react';
...
// Main component for the AI HR & Recruitment Solutions page
export default function AIHRRecruitmentSolutionsPage() {
  ...
  const pageTitle = "AI for HR & Recruitment Optimization | ForgeMission";
  const pageDescription = "Optimize your hiring process and HR tasks with AI-powered candidate sourcing and screening. Solutions by Your ForgeMission."; 
            ...
            <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-xl p-8 md:p-12">
              ...
              <header className="mb-10 text-center">
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-500 mb-4">
                  Optimize HR & Recruitment with AI
                </h1>
                <p className="text-lg text-slate-600">
                  Streamline your hiring, reduce time-to-fill, and find top talent efficiently using our intelligent AI solutions.
                </p>
              </header>
              ...
              <section className="space-y-8">
                ...
                <div className="p-6 bg-slate-50 rounded-lg shadow-lg transition-all hover:shadow-blue-500/20 hover:scale-[1.01]">
                  <h2 className="text-3xl font-semibold text-blue-600 mb-3">
                    {/* Icon placeholder: <Users2 className="inline-block mr-2" /> */}
                    Human Resources & Recruitment Optimization
                  </h2>
                  <p className="text-slate-600 mb-2">
                    <strong className="text-slate-700">Use Case:</strong> AI for Candidate Sourcing and Initial Screening
                  </p>
                  <div className="mt-4 space-y-3 text-slate-700">
                    <h3 className="text-xl font-semibold text-sky-600 mb-2">Problem & Cost Driver:</h3>
                    <p className="text-slate-600">
                      Time-consuming and costly process of sifting through numerous resumes, scheduling interviews, and initial candidate communication.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 bg-slate-50 rounded-lg shadow-lg transition-all hover:shadow-sky-500/20 hover:scale-[1.01]">
                  <h3 className="text-2xl font-semibold text-blue-600 mb-3">
                    {/* Icon placeholder: <SearchCode className="inline-block mr-2" /> */}
                    AI Solution & How it Works:
                  </h3>
                  <ul className="list-disc list-inside space-y-3 text-slate-600 pl-4">
                    <li>
                      AI tools can scan and parse resumes, extracting key information like skills, experience, and education.
                    </li>
                    <li>
                      They can match candidates against job descriptions, ranking them by suitability.
                    </li>
                    <li>
                      Some AI platforms can automate initial communication with candidates and schedule interviews.
                    </li>
                  </ul>
                </div>
                ...
                <div className="p-6 bg-slate-50 rounded-lg shadow-lg transition-all hover:shadow-cyan-500/20 hover:scale-[1.01]">
                  <h3 className="text-2xl font-semibold text-sky-600 mb-3">
                    {/* Icon placeholder: <UserCheck className="inline-block mr-2" /> */}
                    Cost-Savings Achieved:
                  </h3>
                  <ul className="space-y-3 text-slate-700">
                    <li>
                      <strong className="text-slate-800 block mb-1">Reduced Recruiter Workload:</strong>
                      <span className="text-slate-600">
                        Frees up HR staff from manual screening, allowing them to focus on interviewing qualified candidates and strategic HR tasks. Can lower cost-per-hire.
                      </span>
                    </li>
                    <li>
                      <strong className="text-slate-800 block mb-1">Faster Hiring Cycles:</strong>
                      <span className="text-slate-600">
                        Speeds up the initial stages of recruitment.
                      </span>
                    </li>
                    <li>
                      <strong className="text-slate-800 block mb-1">Improved Quality of Hire:</strong>
                      <span className="text-slate-600">
                        Can help identify a wider pool of qualified candidates and reduce bias in initial screening.
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="p-6 bg-slate-50 rounded-lg shadow-lg transition-all hover:shadow-blue-500/20 hover:scale-[1.01]">
                    ...
                    <p className="text-slate-600 mb-3 italic">Your partner for building a smarter, faster hiring pipeline.</p>
                    <ul className="list-disc list-inside space-y-2 text-slate-600 pl-4">
                      <li>Selecting and implementing an AI recruitment tool or Applicant Tracking System (ATS) with AI capabilities.</li>
                      <li>Integrating the tool with job boards and the company careers page.</li>
                      <li>Customizing matching algorithms and screening criteria based on job roles.</li>
                      <li>Ensuring compliance with data privacy and anti-discrimination laws.</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-6 bg-slate-50 rounded-lg shadow-lg transition-all hover:shadow-sky-500/20 hover:scale-[1.01]">
                    ...
                    <p className="text-slate-600 mb-3 italic">Equipping your HR professionals for AI-enhanced recruitment.</p>
                    <ul className="list-disc list-inside space-y-2 text-slate-600 pl-4">
                      <li>Managing job postings through the AI system.</li>
                      <li>Overseeing the AI's screening outputs and making final shortlisting decisions.</li>
                      <li>Ensuring data integrity within the recruitment system.</li>
                      <li>Managing user access for the HR team.</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section className="mt-12 pt-10 border-t border-slate-300 text-center">
                ...
                <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
                  Let our AI experts help you implement solutions that find the best talent faster and more efficiently. Contact us for a strategic HR consultation!
                </p>
